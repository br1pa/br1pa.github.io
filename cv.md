...
[Download my CV as PDF](/assets/pdf/cv.pdf)

## Profile

Data Scientist and Econometrician with expertise in Causal AI, operations research, Econometrics, and Bayesian Methods. My work has focused on developing simulation models, decision-support tools, predictive-risk models, and applied machine learning systems across financial regulation and healthcare. I am particularly interested in explainable AI, probabilistic modelling, and policy-facing analytics. 
...
- Technical Lead for the Innovation, Research and Projects function in Market Oversight Data and Intelligence. Leading a team of Data Scientists and Quantitative Researchers.
- Developed a bilateral RFQ-driven simulation of the UK gilt market, modelling dealer and investor behaviours under market stress scenarios.
- Analysed liquidity, spread, volatility, and market abuse dynamics under scenarios including GEMM withdrawal and absence of central-bank intervention.

**Lead Data Scientist**  
*July 2022 – October 2025*

- Led data science work in the Enforcement and Financial Crime Data Science Unit, with a focus on market abuse and money laundering.
- Prototyped an explainable Bayesian decision-support tool for liquidity risk supervision under the Investment Firms Prudential Regime.
- Applied causal machine learning to identify drivers of customer financial vulnerability during the cost-of-living crisis.
- Built and deployed a Bayesian AI Streamlit application to map regulatory journeys to outcomes.
- Won the FCA’s inaugural Data Science Lab competition with an operations research capacity-planning tool.
- Managed stakeholder relationships up to Head of Department and Director level.
- Oversaw the development and performance of four data scientists.

### National Health Service, London, UK

**Lead Data Scientist and Econometrician**  
**Health Economics Modeller**  
**Senior Financial Strategy Analyst**  
**Financial Strategy Analyst**  
*October 2017 – June 2022*

- Led development of predictive-risk models for NHS trusts, including a self-harm risk classifier for young adult inpatients.
- Designed causal AI frameworks to identify drivers and interventions for critical conditions such as sepsis.
- Co-founded a cross-organisational machine learning Community of Practice for NHS England.
- Delivered more than 20 analytics projects for internal and external stakeholders.
- Built econometric and budget-impact models to evaluate healthcare technologies and interventions.
- Managed and mentored a team of six data scientists and data engineers.
...
**MSc in Big Data Science with Distinction**  
Queen Mary University of London, London, UK  
*Graduated 2021*

**MSc in Financial Economics with Distinction**  
